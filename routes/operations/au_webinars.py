...
def ops_australia_webinars_edit_page(rid):
    ...
    return render_template(
        ...
        **section_webinars_lookups('australia'),
    )
...
@admin_required
def ops_australia_webinars_add_page():
...
@admin_required
def ops_australia_webinars_add_save():
    """POST — insert a new Australia webinar / conference row."""
    conn = get_db()
    try:
        ...
        return redirect(url_for('ops_australia_webinars_detail', rid=new_id))
    except Exception as e:
        logging.error(f"ops_australia_webinars_add_save: {e}")
...
def register_routes(app):
    ...
    app.add_url_rule(
        '/operations/australia/webinars/add',
        endpoint='ops_australia_webinars_add_page',
        view_func=ops_australia_webinars_add_page,
        methods=['GET'],
    )
    app.add_url_rule(
        '/operations/australia/webinars/add',
        endpoint='ops_australia_webinars_add_save',
        view_func=ops_australia_webinars_add_save,
        methods=['POST'],
    )
    app.add_url_rule(
