...
IMPORT_VERSION = 'au_lookups_v5_extra_categories'
...
LOOKUP_SOURCES = [
    ...
    # PLAB Test Bookings form has a Yes/No revaluation dropdown. AMC uses
    # the same category so admins seeing 'No values' can edit through
    # Field Manager just like PLAB. Falls back to ['Yes','No'] if empty.
